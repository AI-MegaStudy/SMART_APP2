...
def serialize_order(order: Order) -> dict:
    return {
        ...
        "shipment_id": order.shipment.shipment_id if order.shipment else None,
        "carrier_name": order.shipment.carrier_name if order.shipment else None,
        ...
        "shipped_package_count": order.shipment.shipped_package_count if order.shipment else None,
        "shipped_kg": float(order.shipment.shipped_kg) if order.shipment else None,
        "shipped_at": order.shipment.shipped_at if order.shipment else None,
        "delivered_at": order.shipment.delivered_at if order.shipment else None,
